...
/**
 * This class represents a container class to hold a Vector in space and
 * direction the ship will move. Assuming the center of the ship is the origin
 * the angles can be determined by a unit circle via Cartesian coordinates. When
 * the user clicks on the screen the mouse coordinates or screen coordinates
 * will be stored into the mx and my instance variables. The x and y data
 * members are converted to cartesian coordinates before storing.
 *
 * I purposefully left out getters and setters. In gaming just keep things
 * minimalistic.
 *
 * @author cdea
 */
public class CustomVector {
    ...
    /**
     * Constructor will convert mouse click points into Cartesian coordinates
     * based on the sprite's center point as the origin.
     *
     ...
     */
    public CustomVector(double mx, double my, double centerX, double centerY) {
