...
public abstract class GameEngine {
    ...
    protected final void buildAndSetGameLoop() {
        ...
        //Depending on the framespersecond the game will update itself after a certain period repeatedly
    ...
    protected void handleUpdate(Sprite sprite) {
        ...
        //TODO Add all the sprites to be removed in the set SpriteManager.spritesTobeRemoved
    }
    ...
    protected void checkCollisions() {
        ...
        //Add all the sprites to be removed in the set SpriteManager.spritesTobeRemoved
